...
If cloud context is incomplete, say what capability is missing at a safe level. Do not print secret names, secret values, token lengths, service-account metadata, or sensitive inventory details.

## What You Post Back To GitHub

Post an incident report with symptom, impact, evidence, likely cause, confidence, recommended action, and whether a PR was opened. Keep the report focused on evidence and human next steps.
