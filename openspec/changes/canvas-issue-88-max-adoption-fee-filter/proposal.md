...
- GitHub issue: https://github.com/rajshah4/sdlc-automation-github-demo/issues/88 — Story: filter pets by maximum adoption fee
...
- Run: canvas-issue-88-workflow-pr-20260707-1258
...
- `app/petstore_app/catalog.py`: `search_pets()` gains an optional `max_fee_cents: int | None` parameter with validation and per-pet filter predicate.
- `app/tests/test_pet_catalog.py`: four focused tests for the new parameter.
- `app/web/index.html`: max fee dollar input inside the toolbar.
