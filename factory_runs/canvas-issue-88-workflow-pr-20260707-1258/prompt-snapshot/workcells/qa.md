...
7. Do not install new dependencies during an unattended factory run unless
...
Do not create the PR yourself. Write the QA artifact and evidence for the parent
automation to sync into the PR body.
