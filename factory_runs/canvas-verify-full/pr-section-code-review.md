...
Implementation report: `factory_runs/canvas-verify-full/story-to-pr.md`

## 3. Code Review

Review status: changes recommended

Review report: `factory_runs/canvas-verify-full/code-review.md`
...
- `python3 -m pytest -q`
- `python3 agent-canvas/scripts/run_petstore_playwright_qa.py --artifact-dir factory_runs/<run-id>/playwright-artifacts --playwright-node-path <playwright-node-path>`
