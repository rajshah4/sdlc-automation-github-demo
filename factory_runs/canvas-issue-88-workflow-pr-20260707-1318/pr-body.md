...
Implementation report: `factory_runs/canvas-issue-88-workflow-pr-20260707-1318/story-to-pr.md`
...
- `python3 -m pytest -q`
- `NODE_PATH=<playwright-node-path> node app/web/tests/catalog-search.playwright.mjs --artifact-dir factory_runs/<run-id>/playwright-artifacts`
