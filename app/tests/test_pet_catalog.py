...
def test_search_pets_filters_by_minimum_age() -> None:
    # Mochi=18mo, Scout=28mo, Pip=9mo available; Nova=14mo pending
...
def test_search_pets_includes_boundary_ages() -> None:
    # Mochi is exactly 18 months
...
def test_search_pets_rejects_inverted_age_range() -> None:
    with pytest.raises(ValueError, match="min_age_months cannot exceed max_age_months"):
        search_pets(min_age_months=25, max_age_months=10)


def test_search_pets_no_age_filter_when_none() -> None:
